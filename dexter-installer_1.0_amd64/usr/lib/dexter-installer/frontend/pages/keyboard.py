...
class KeyboardPage:
    ...
    def __init__(self, app):
        ...
        title = Gtk.Label()
        title.set_markup("<span foreground='white' size='xx-large' weight='bold'>Distribución del teclado</span>")
        ...
        subtitle = Gtk.Label()
        subtitle.set_markup("<span foreground='white' size='medium'>¿Cuál es la distribución de tu teclado?</span>")
        subtitle.set_halign(Gtk.Align.START)
        subtitle.set_margin_start(160)
